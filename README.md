...
This project demonstrates how to wrap an API in a UiPath library project, turning it into reusable activities for low-code workflows. It's a partial implementation of the Swagger Petstore API, meant as an internal example for our team—no plans to expand or publish it.
